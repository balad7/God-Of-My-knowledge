	...
	$data = get_post_meta($page_id); ?>
      ...
      <input type="hidden" name="hidden_event_cat" id="hidden_event_cat" value="" />
                ...
                <div class="row">
                	<div class="blog_filter_right">
                    	...
                    	<div class="custom_select"><?php
							...
							if($prod_categories){?>
                                <select  class="" onchange="rec_page_main_post_filter(this);">
       ...
       <div class="blog_post blog_equal white">
       		<div class="container">
            	<div class="row main_rec_section">
					<div class="rec_post_list"><?php load_rec_main_post( 1, '', '');?></div>
                <div class="load_more">
