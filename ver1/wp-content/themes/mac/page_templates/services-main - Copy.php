<?php
/**
 * Template Name: Services Main Bk
 *
 * @package WordPress
					...
					if($main_list_section){
                        ...
                        <div class="services_row">
								<div class="service_middle_top center">                                    
									<h2 class="section_title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>services/web-development"><?php  echo $title['service_main_title'];?></a></h2>                     
								</div><?php 
                                    ...
                                    <div class="service_middle_info col l12 s12 m12"><?php
                                        ...
                                        <div class="col l3 m3 s12">
                                            <div class="service_middle_info_inner" >                                                
                                                <h6 class="service_middle_text"><a href="<?php echo esc_url( home_url( '/' ) ); ?>services/web-development/responsive-web-design-india"><?php echo $loop['list_title'];?></a></h6><?php
