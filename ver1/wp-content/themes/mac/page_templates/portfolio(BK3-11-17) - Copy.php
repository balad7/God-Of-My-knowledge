                          ...
                          <ul><?php
                              ...
                              if($project_type){
                                  foreach($project_type as $type ){?>
                                      <li><a href="#<?php echo $type->slug;?>" class="btn-medium btn-gray" data-normal="<?php echo $type->slug;?>" data-hover="<?php echo $type->slug;?>"><div><?php echo $type->name;?></div></a></li><?php
                                  }
                              }?>
                               <li class="reset"><a href="#all" class="btn-medium" data-normal="all" data-hover="all"><div>RESET</div></a></li>
                          </ul>
                    </div><?php
				}
                    ...
                    <div class="gu grid"><?php
                            $i= 1;
                             while ( $loop->have_posts() ) : $loop->the_post();
                                ...
                                <div class="g <?php if($terms){ echo implode(" ",$term_arr); }echo ' ';if($types){echo implode(" ",$type_arr);}?> " data-background="<?php echo $term_color[0];?>">
                                    <div class="wrapper" >
