                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>services/inbound-marketing/outsource-social-media-marketing-services">Outsource SMM</a></li>
                                 <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>services/inbound-marketing/hubspot-cos-services">Hubspot COS services</a></li>
                ...
                <ul class="sub-menu cols2">
                    <li>
                        <ul class="multi_column">
                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>resource/tutorials">DeskPro</a>
                            	<p>chat on app</p>
                            </li>
                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>resource/articles">Consult Martino</a>
                            	<p>an app for lawyer</p>
                            </li>
                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>resource/articles">FixMySPA</a>
                            	<p>an app for beauty parlorr</p>
                            </li>
                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>resource/sathiyavedham">TrackMyWorkout</a>
                    ...
                    <li>
                        <ul class="multi_column">
                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>resource/scripts">PetTime</a>
                                <p>an app for pet advisors</p>
                            </li>
                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>resources/seo-for-beginners">DentisTime</a>
                                <p>an app for dental</p>
                            </li>
                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>resources/seo-for-beginners">Token Number Ten</a>
                                <p>an app for food delivery </p>
                            </li>
                         </ul>
                    </li>
                </ul>
