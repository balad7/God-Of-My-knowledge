...
<header class="menu_first">
  ...
  <div class="header_inner">
    ...
    <ul class="menu" id="menu">
        ...
        <li class="menu-has-children"><a href="<?php echo esc_url( home_url( '/' ) ); ?>about-us">About us</a>
            ...
            <!--<a href="javascript:void(0)" class="menu_close">x</a>-->
                ...
                <ul class="sub-menu cols3">

                   <!-- <li>

                        <ul class="multi_column heights_cols">-->
                            ...
                            <p>5500+ Web and Mobile Projects</p>
                    ...
                    <li>
                        ...
                        <ul class="multi_column heights_cols">-->
                            ...
                            <p>We are hiring. Jobs are listed here.</p>

                            </li>

                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>about-us/case-studies">Case Studies</a>

							<p>Details of some project samples discussed.</p>

                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>price-quote">Price Quote </a>

							<p>Custom proposals for your requirments.</p>

                            

                            <?php /*?><li><a href="<?php echo esc_url( home_url( '/' ) ); ?>pricing-models#fixed_cost">Fixed Cost Model</a>
    	...
    	<li class="menu-has-children"><a href="<?php echo esc_url( home_url( '/' ) ); ?>portfolio">Portfolio</a>
			<div class="sub_menu_bg"> 
            ...
            <!--<a href="javascript:void(0)" class="menu_close">x</a>-->
                ...
                <ul class="sub-menu cols3">
                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>portfolio">Web Development</a>

                            <p>Get a view into our Capability</p>

                            </li>

                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>products">Mobile Development</a>

                            <p>Get a view into our Capability </p>

                            </li>

                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>services/inbound-marketing/seo-portfolio">SEO</a>
                        ...
                        <ul class="multi_column menu_title_bg">
                            ...
                            <li> <a class="menu_title" href="<?php echo esc_url( home_url( '/' ) ); ?>services/custom-web-development">Custom Web Development</a>
                                ...
                                <ul>
                                    ...
                                    <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>services/custom-web-development/angular-development-company">Angular Development</a></li>
                    ...
                    <ul class="multi_column menu_title_bg">
                        ...
                        <li> <a class="menu_title" href="<?php echo esc_url( home_url( '/' ) ); ?>services/ecommerce-development">ECommerce Development</a>
                            ...
                            <ul>
                                ...
                                <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>services/ecommerce-development/prestashop-development-india">Prestashop Development</a></li>
                    ...
                    <ul class="multi_column menu_title_bg">
                        ...
                        <li> <a class="menu_title" href="<?php echo esc_url( home_url( '/' ) ); ?>services/data-analytics-and-consulting">Data Analysis</a>
                            ...
                            <ul >
                            	...
                            	<li><a href="<?php echo esc_url( home_url( '/' ) ); ?>services/data-analytics-and-consulting/outsource-business-intelligence">Business Intelligence</a></li>

                            	<li><a href="<?php echo esc_url( home_url( '/' ) ); ?>services/data-analytics-and-consulting/tableau-consulting-services">Tableau Consulting Services</a></li>
								<li><a href="<?php echo esc_url( home_url( '/' ) ); ?>services/data-analytics-and-consulting/bi-dashboards">BI Portfolio</a></li>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>services/inbound-marketing/outsource-social-media-marketing-services">Outsource SMM</a></li>
                                 ...
                                 <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>services/inbound-marketing/hubspot-cos-services">Hubspot CMS services</a></li>

                                 <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>services/inbound-marketing/ppc-marketing-services">PPC marketing Services</a></li>
        ...
        <li class="menu-has-children"><a href="<?php echo esc_url( home_url( '/' ) ); ?>products">Products</a>
                ...
                <ul class="sub-menu cols2">
                    ...
                    <li>
                        ...
                        <ul class="multi_column">
                            ...
                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>products/deskpro">DeskPro</a>

                            	<p>Sales Chat Mobile App</p>

                            </li>

                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>products/consult-martino">Consult Martino</a>

                            	<p>Attorny appoinment App</p>

                            </li>

                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>products/fixmyspa">FixMySPA</a>

                            	<p>SPA Booking app</p>

                            </li>

                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>products/trackmyworkout">TrackMyWorkout</a>

                            	<p>Your fitness center app</p>
                    ...
                    <li>
                        ...
                        <ul class="multi_column">
                            ...
                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>products/pettime">PetTime</a>

                                <p>Pet Spa app</p>

                            </li>

                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>products/dentistime">DentisTime</a>

                                <p>Appoinment booking with Dentists</p>

                            </li>

                            <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>products/token-number-ten">Token Number Ten</a>

                                <p>Self-service Restaurant app </p>
    ...
    <li><a href="https://www.macronimous.com/sathiyavedham/">Mobile App - Tamil Bible</a>
    ...
    <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>resources/seo-for-beginners">SEO for beginners</a>
