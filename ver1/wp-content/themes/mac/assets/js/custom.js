...
jQuery(function($){
	...
	jQuery('header').addClass('menu_closed');
		...
		/*For mega menu overflow-scroll*/
		if(winwidth <= 910) {
			_winheight = jQuery(window).outerHeight();
			navheight = jQuery('.nav-wrapper').outerHeight();
			menuheight = _winheight - navheight;
			jQuery('.wp-megamenu-main-wrapper.wpmm-orientation-horizontal ul.wpmm-mega-wrapper').css("height",menuheight);
			jQuery('.wp-megamenu-main-wrapper').click(function(){
				jQuery('body').toggleClass("menu_open");
			});
			var ss = jQuery('.wp-megamenu-main-wrapper.wpmm-orientation-horizontal ul.wpmm-mega-wrapper').outerHeight();
			//jQuery('.wp-megamenu-main-wrapper.wpmm-orientation-horizontal ul.wpmm-mega-wrapper').css("height",ss);
			//alert(ss);
		}
