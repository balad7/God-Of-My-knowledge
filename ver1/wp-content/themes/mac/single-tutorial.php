        	...
        	<div class="container">
            	<div class="row">
					<div class="breadcrumbs" vocab="https://schema.org/" typeof="BreadcrumbList">
                        ...
                        <span property="itemListElement" typeof="ListItem">
                            <a property="item" typeof="WebPage" title="Go to Tutorials." href="<?php echo esc_url( home_url( '/' ) ); ?>resource/tutorials" class="post post-page">			
		...
		if($loop->found_posts > 0) {?>
           <div class="blog_post blog_equal white">
                <div class="container">
                    <div class="row">
                        <div class="col s12">
                            <h2 class="section_title">Related Tutorials</h2>
                        </div>
                        <!-- blog all post -->
                                    ...
                                    <div class="blog_all_inner">
                                        <div class="blog_post_img">
                                           <?php /*?> <div class="blog_info">
                                        	...
                                        	$terms = get_the_terms(get_the_ID(), 'resources-category' );
											if($terms){
												$cat_link = array();
