	...
	if (have_posts()) : while (have_posts()) : the_post();
        ...
        <div class="banner blog_single" style="background-image:url(<?php echo $banner_image[0];?>);background-color:<?php echo get_field('banner_background_color'); ?>;background-size:<?php echo get_field('banner_background_image_size'); ?>;">
            ...
            <div class="banner_heading">
                <div class="banner_inner_bg">
                	<div class="banner_text">
                    	 <h4>Free Scripts - Code Snippets</h4>
                          <h1><?php the_title();?></h1>
                    </div>
                </div>
            </div>
            <div class="container"><?php
                $category = ' ';
                $category = get_the_terms( get_the_ID(), 'script-category' );
                if($category){?>
                  <!--  <div class="post_category">-->
                        <!--<ul>--><?php
                            ...
                            foreach ( $category as $cat ){
                                $list[] = $cat->slug;
								 $link1[]= '<a href="' . get_term_link( $cat->term_id ) . '" ">' . $cat->name .'</a>';
								  $name[]=  $cat->name;
                	 ...
                	 <?php /*?><nav>
                        <div class="nav-wrapper">
                          <div class="col s12">
                            ...
                            <a href="<?php echo esc_url( home_url( '/' ) ); ?>resource/scripts" class="breadcrumb">Free Scripts - Code Snippets</a>
		...
		if($loop->found_posts > 0) {?>
           <div class="blog_post blog_equal white">
                <div class="container">
                    <div class="row">
                        <div class="col s12">
                            <h2 class="section_title">Related Scripts</h2>
                        </div>
                        <!-- blog all post -->
